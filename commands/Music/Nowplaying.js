...
module.exports = {
    ...
    run: async (interaction, client, user, language, player) => {
        ...
        const embeded = new EmbedBuilder()
            ...
            .setDescription(`${player.playing ? client.i18n.get(language, "music", "np_title") : client.i18n.get(language, "music", "np_title_pause")} [${subText(song.title, 70)}](${song.url}) [${song.requester}]`)
